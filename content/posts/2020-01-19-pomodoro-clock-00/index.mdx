...
description: Set up your React development environment for your freeCodeCamp Pomodoro Clock
date: 2020-01-19
...
function App() {
  return (
    <div className="App">
      <Break />{/* Add Break component here */}
    </div>
  );
}
...
If you are interested in the freeCodeCamp Random Quote Machine implementation,
please take a look at [my videos on
YouTube](https://www.youtube.com/playlist?list=PL3cz80ehFCan4srLIp1HmhrQ0CU8Cw9XM).
