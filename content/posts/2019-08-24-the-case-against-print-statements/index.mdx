...
A coworker (who is new to our codebase) recently asked me to add print statements, specifically `console.log()` statements (as we're using React Native), to our codebase wherever an "important event" happens. He explained that this would help him understand what exactly in the codebase.
...
This blog post is my argument against allowing informational print statements in a codebase's main development branch.
